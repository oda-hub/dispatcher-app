...
def dispatcher_test_conf_with_matrix_options_fn(dispatcher_test_conf_fn):
    ...
    with open(fn, "w") as f:
        ...
        f.write('\n    matrix_options:'
                ...
                f'\n        matrix_cc_receivers_room_id: ["{os.getenv("MATRIX_CC_RECEIVER_ROOM_ID", "matrix_cc_receivers_room_id")}"]'
                f'\n        matrix_incident_report_receivers_room_ids: ["{os.getenv("MATRIX_INCIDENT_REPORT_RECEIVER_ROOM_ID", "matrix_incident_report_receivers_room_id")}"]'
